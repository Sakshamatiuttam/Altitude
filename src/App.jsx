            ...
            <div className="flex  flex-row ">
              <div className="pl-8">
                ...
                <div className="mt-4 flex  w-full font-mono font-light text-md">
                  <div className="mr-2  w-[60%] flex flex-col justify-between items-start">
                    <p className="">
                    ...
                    <div>
                      <div className="flex mb-4 ml-7 justify-end items-center md:justify-start gap-5 pt-4">
                  ...
                  <div className="flex  mt-10 md:mt-0  w-[40%] overflow-hidden">
